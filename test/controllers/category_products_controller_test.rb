...
class CategoryProductsControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:categories_products)
  end
  ...
  test "should update category_product" do
    patch :update, id: @category_product, category_product: { category_id: @category_product.category_id, product_id: @category_product.product_id }
    assert_redirected_to category_product_path(assigns(:category_product))
  end
