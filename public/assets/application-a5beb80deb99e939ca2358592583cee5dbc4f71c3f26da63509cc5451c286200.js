...
App.Helpers = {
  ...
  _alertLocationRequired: function () {
    ...
    new $.popup({
      ...
      '<small> Nous promettons, aucun spam, aucun emplacement ou données personnelles partagés!  </small>' +
      ...
      '</a>' +
      '<a style="padding:4px">' +
      '<span class="facebook-messenger__text"> Comment activer la géolocalisation? </span>' +
      '</a>' +
      '</div>',
      html: true,
      buttons: false
