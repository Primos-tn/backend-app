            ...
            <div className="col-lg-12">
                 <div className="ProductDetails col-lg-12">
                    ...
                    <ul className="nav nav-tabs">
                        <li className={activeTab == WISHERS_TAB ? ACTIVE_CLASS : ''}>
                            <a href={App.Helpers.getAbsoluteUrl(App.Routes.productWishers, { id : this.props.id})}>
                                <i className="fa fa-circle"></i> Wishers
                            </a>
                        </li>
                        ...
                        <li className={activeTab == REVIEWS_TAB ? ACTIVE_CLASS : ''}>
                            <a href={App.Helpers.getAbsoluteUrl(App.Routes.productReviews, { id : this.props.id})}>
