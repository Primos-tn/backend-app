...
describe Admin::CategoriesController do
  ...
  describe "GET new" do
    it "assigns a new admin_category as @admin_category" do
      ...
      assigns(:admin_category).should be_a_new(Admin::Category)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin_category as @admin_category" do
        post :create, {:admin_category => valid_attributes}, valid_session
        assigns(:admin_category).should be_a(Admin::Category)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_category as @admin_category" do
        ...
        Admin::Category.any_instance.stub(:save).and_return(false)
        post :create, {:admin_category => {}}, valid_session
        assigns(:admin_category).should be_a_new(Admin::Category)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_category" do
        ...
        # specifies that the Admin::Category created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Category.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => category.to_param, :admin_category => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_category as @admin_category" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Category.any_instance.stub(:save).and_return(false)
        put :update, {:id => category.to_param, :admin_category => {}}, valid_session
        assigns(:admin_category).should eq(category)
      end
